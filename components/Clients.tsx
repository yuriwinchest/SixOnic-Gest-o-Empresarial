    ...
    <div className="space-y-6">
      ...
      <div className="flex space-x-1 border-b border-white/10">
        <button
          ...
          className={`px-6 py-3 font-medium text-sm transition-colors relative ${activeTab === 'Cliente' ? 'text-indigo-400' : 'text-slate-400 hover:text-slate-200'
            }`}
        >
        ...
        <button
          ...
          className={`px-6 py-3 font-medium text-sm transition-colors relative ${activeTab === 'Fornecedor' ? 'text-indigo-400' : 'text-slate-400 hover:text-slate-200'
            }`}
        >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
          <div className="bg-slate-900 border border-white/10 rounded-xl shadow-2xl w-full max-w-3xl my-8 animate-scale-in">
            <div className="max-h-[85vh] overflow-y-auto custom-scrollbar">
              <div className="p-6 sticky top-0 bg-slate-900 border-b border-white/10 z-10">
